  ...
  <div class="slide bg-[#0b0b18] flex flex-col items-center justify-center text-center px-8 overflow-hidden">
    ...
    <div class="relative z-10 flex flex-col items-center gap-6">
      <div
        ...
        :style="{ opacity: mounted ? 1 : 0, transform: mounted ? 'scale(1)' : 'scale(0.5)', transition: 'opacity 0.5s cubic-bezier(0.34, 1.56, 0.64, 1), transform 0.5s cubic-bezier(0.34, 1.56, 0.64, 1)' }"
      >
        <TrendingUp class="w-10 h-10 text-white" />
      </div>

      <div :style="{ opacity: mounted ? 1 : 0, transform: mounted ? 'none' : 'translateY(16px)', transition: 'opacity 0.6s ease, transform 0.6s ease', transitionDelay: '200ms' }">
      ...
      <div
        ...
        :style="{ opacity: mounted ? 1 : 0, transform: mounted ? 'none' : 'translateY(16px)', transition: 'opacity 0.6s ease, transform 0.6s ease', transitionDelay: '600ms' }"
      >
