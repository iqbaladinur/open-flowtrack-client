export default {
  ...
  categories: {
    ...
    createFirstCategory: 'Create your first category to start organizing your finances.',
  ...
  transactions: {
    ...
    noNote: 'no note',
    onWallet: 'on wallet',
    shareTransactionData: 'Here is my transactions data for the selected period',
  },
  ...
  budgets: {
    ...
    createFirstBudget: 'Create your first budget for the selected date range to start tracking your spending.',
  ...
  reports: {
    ...
    healthyZoneDesc: 'Your expense ratio is great! This suggests you have a strong handle on your finances, with income significantly higher than expenses. Keep it up!',
    cautionZone: 'Caution Zone:',
    cautionZoneDesc: "You're spending a significant portion of your income. It's a good time to review your budget and see if there are opportunities to save more.",
    dangerZone: 'Danger Zone:',
    dangerZoneDesc: 'Your expenses are very close to your income. This is a high-risk situation. We strongly recommend creating a budget and cutting back on non-essential spending.',
    noIncomeRatio: "Your expense ratio couldn't be calculated because there was no income in this period. The ratio shows what percentage of your income is spent.",
    barView: 'Bar View',
    lineView: 'Line View',
  ...
  profile: {
    ...
    dangerZone: 'Danger Zone',
    dangerZoneWarning: 'This action is irreversible. Please be certain before proceeding.',
    logout: 'Logout',
  ...
  backup: {
    ...
    createBackupDesc: 'Download a backup of all your data. Keep this file in a safe place.',
    download: 'Download',
    share: 'Share',
    restoreFromBackup: 'Restore from Backup',
    restoreFromBackupDesc: 'Restore your data from a backup file. This will overwrite all existing data.',
  ...
  onboarding: {
    ...
    subtitle: "Select the categories you'd like to start with. You can always change this later.",
    expenses: 'Expenses',
    income: 'Income',
    continue: 'Continue',
  ...
  bulkExpense: {
    ...
    step2Desc: 'Correct any errors in the extracted text. This text will be sent to the server for processing.',
    ...
    ocrError: 'An error occurred during OCR processing. Please check the console.',
    previewError: 'Failed to get transaction preview. Please check the console.',
    apiError: 'An API error occurred. Please check the console.',
    saveSuccess: 'transactions saved successfully!',
    saveError: 'An error occurred while saving transactions. Please check the console for details.',
  },
