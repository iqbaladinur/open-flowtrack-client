export default {
  ...
  reports: {
    ...
    totalBudgetAllocated: "Total Allocated",
    totalBudgetSpent: "Total Spent",
    averageBudgetUsage: "Average Usage",
    budgetStatus: "Budget Status",
    onTrackBudgets: "On Track",
    overBudget: "Over Budget",
    totalRemaining: "Total Remaining",
    budgetPerformanceChart: "Budget Performance Chart",
    budgetPerformanceDescription: "Compare budget limits with actual spending",
    budgetPerformanceDetails: "Budget Performance Details",
    budgetPerformanceDetailsDesc: "Detailed breakdown of each budget",
    byUsage: "By Usage",
    bySpent: "By Spent",
    byName: "By Name",
    noBudgetData: "No budget data available",
    noBudgetsInPeriod: "No budgets found in this period",
    usage: "Usage",
    ...
    healthyStatusDesc: "Your net income can cover the remaining budget and more. You're in a strong financial position.",
    cautionStatus: "Caution",
    cautionStatusDesc: "Your net income is positive but less than the remaining budget. Monitor spending carefully to avoid overspending.",
